  ...
  return (
    <header className="sticky top-0 py-4 bg-background border-b border-border ">
      <div className="container mx-auto px-4 flex items-center justify-between">
        <h1 className="text-xs sm:text-sm md:text-lg font-bold text-primary animate-typing overflow-hidden whitespace-nowrap border-r border-primary pr-2 sm:pr-5">
